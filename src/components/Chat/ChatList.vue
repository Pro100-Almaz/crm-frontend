  ...
  <div class="flex max-h-full flex-col overflow-auto p-5">
    ...
    <div class="no-scrollbar max-h-full space-y-2.5 overflow-auto">
      ...
      >
        ...
        <div class="w-full">
          <h5 class="text-sm font-medium text-black dark:text-white">Henry Dholi</h5>
      ...
      >
        ...
        <div class="w-full">
          <h5 class="text-sm font-medium text-black dark:text-white">Mariya Desoja</h5>
          <p class="text-sm font-medium">I like your confidence 💪</p>
        </div>
      </div>
      <div
        class="flex cursor-pointer items-center rounded py-2 px-4 hover:bg-gray-2 dark:hover:bg-strokedark"
      >
        ...
        <div class="w-full">
          <h5 class="text-sm font-medium text-black dark:text-white">Robert Jhon</h5>
          <p class="text-sm font-medium">Can you share your offer?</p>
        </div>
      </div>
      <div
        class="flex cursor-pointer items-center rounded py-2 px-4 hover:bg-gray-2 dark:hover:bg-strokedark"
      >
        ...
        <div class="w-full">
          <h5 class="text-sm font-medium text-black dark:text-white">Cody Fisher</h5>
          <p class="text-sm font-medium">I'm waiting for you response!</p>
        </div>
      </div>
      <div
        class="flex cursor-pointer items-center rounded py-2 px-4 hover:bg-gray-2 dark:hover:bg-strokedark"
      >
        ...
        <div class="w-full">
          <h5 class="text-sm font-medium text-black dark:text-white">Jenny Wilson</h5>
          <p class="text-sm font-medium">I cam across your profile and...</p>
        </div>
      </div>
    </div>
